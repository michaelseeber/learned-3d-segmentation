...
SCANNET_DIR = 'C:/Users/michi/OneDrive/Dokumente/ETH/BachelorThesis/code/thesis/data/scenes'
...
def collect_one_scene_data_label(scene_name, out_filename):
    ...
    points = pc_util.read_ply_rgb(ply_filename)
...
if __name__=='__main__':
    output_folder = 'scannet_preProcessed_scenes'
