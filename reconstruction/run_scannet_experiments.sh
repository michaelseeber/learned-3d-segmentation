SCANNET_PATH=/scratch/code/LearningPriors

for scene_path in $(ls -d $SCANNET_PATH/scenes/scene*)
do
    ...
    python3 $SCANNET_PATH/TSDF/convert_scannet.py \
        ...
        --label_map_path $SCANNET_PATH/scannet-labels.combined.tsv \
        --resolution 0.05
    ...
    python $SCANNET_PATH/eval_tv_l1.py \
        ...
        --niter_steps 50 --lam 0.1 --nclasses 42 
